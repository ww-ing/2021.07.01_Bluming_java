...
public class SubChatPageBetaP extends JFrame {
   JPanel p = new JPanel(new BorderLayout());
   JPanel pN, pS, pC;
   
   JTextField tf=new JTextField("Send a message",45);
   ...
   Font fontChatName = new Font("", Font.BOLD,20);
...
//      pEmoticon.setLayout(new GridLayout(2, 4, 2, 0));
      ...
      //硫붾 �� 移쒓 �� �� ���  踰꾪 �� 
      Font CS50 = new Font("SF Comic Script", Font.BOLD,50);
